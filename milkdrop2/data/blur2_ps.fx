...
#define edge_darken_c3 _c6.w
    ...
    float2 uv2 = uv.xy + srctexsize.zw * float2(1, 0); // + moves blur UP, LEFT in 2-pixel increments since texture is half the size of "blur1_ps"
