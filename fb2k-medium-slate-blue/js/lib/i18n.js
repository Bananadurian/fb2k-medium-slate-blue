...
const I18N = {
  ...
  control_buttons: {
    ...
    device_asio:    { en: "Current: ASIO (Click for WASAPI shared)", zh: "当前: ASIO (点击切换 WASAPI shared)" },
    device_wasapi_ex: { en: "Current: WASAPI (Click for WASAPI shared)", zh: "当前: WASAPI (点击切换 WASAPI shared)" },
    device_wasapi:  { en: "Click to Switch to ASIO",                zh: "点击切换 ASIO" },
    mute:           { en: "Mute",                                   zh: "静音" },
