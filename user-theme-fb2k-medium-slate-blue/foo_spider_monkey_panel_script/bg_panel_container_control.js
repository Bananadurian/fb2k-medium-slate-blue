...
const SUB_PANELS = {
    ...
    infoRatePanel: {key: "infoRatePanel", panelCaption: "info_rating", panelIndex: 1, x: 0, y: 0, w: _scale(40), h: _scale(40), panel: null, missingLogged: false},
...
const PANEL_CFG = {
    ...
    padding: {top:0, right:_scale(8), bottom:_scale(8), left:_scale(8)},
