...
const CONFIG = {
    ...
    TEXT_COLOR: RGB(200, 200, 200)   // 提示文字颜色
};
...
/**
 * 将 RGB 值转换为 GDI 32位 ARGB (0xAARRGGBB)
 */
function RGB(r, g, b) {
...
function create_rounded_image(img, target_w, target_h, radius) {
    ...
    gr_mask.FillSolidRect(0, 0, target_w, target_h, RGB(255, 255, 255));
    gr_mask.FillRoundRect(0, 0, target_w, target_h, radius, radius, RGB(0, 0, 0));
